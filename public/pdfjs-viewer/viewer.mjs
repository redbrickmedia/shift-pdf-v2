...
var es_promise_with_resolvers = __webpack_require__(4628); // ./web/event_utils.js
const WaitOnType = {
  EVENT: 'event',
  TIMEOUT: 'timeout',
};
...
async function docProperties(pdfDocument) {
  ...
  return {
    ...
    filename:
      ...
      generic_scripting_getPdfFilenameFromUrl(url),
...
var es_iterator_find = __webpack_require__(116); // ./web/menu.js
class Menu {
  #triggeringButton;
  #menu;
  #menuItems;
  ...
  constructor({
    ...
    if (this.#enableSplitMerge && manageMenu) {
      ...
      this.#undoCloseButton?.addEventListener(
        'click',
        this.#dismissUndo.bind(this, true)
      );
...
const PDFViewerApplication = {
  ...
  async initialize(appConfig) {
    ...
    if (
      ...
      AppOptions.set('enablePermissions', false);
    }
